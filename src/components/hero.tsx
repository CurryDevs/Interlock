    ...
    >
      <div className="z-10 flex w-full flex-col items-center text-[#0e0e0e] lg:items-start 3xl:max-w-[1200px]">
        <motion.h1
          ...
          className="h-auto w-full text-center text-[60px] max-[420px]:text-[52px] font-semibold leading-[60px] tracking-[-3px] opacity-[0.8704] md:h-[160px] md:w-[649px] md:text-[80px] md:leading-[80px] lg:text-left"
        >
