...
const testimonials = [
  {
    ...
    description: (
      <p>
        Using UIForge has revolutionized our design process.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s templates have drastically improved our development
        speed.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        sacrificing quality. UIForge&apos;s stunning designs and simple
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s prebuilt components have made it so easy to create
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s animations and design elements have elevated our fintech
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s component library has simplified web development for our
        logistics dashboard.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s responsive designs have helped us create marketing sites
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s beautifully crafted components have completely
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge has made it easy to create user-friendly, accessible interfaces
  ...
  },
  {
    ...
    description: (
      <p>
        UIForge&apos;s education-focused templates have doubled our
  ...
  return (
    <section id="testimonials" className="container py-10">
      ...
      <h3 className="mx-auto mb-8 max-w-lg text-balance text-center text-lg font-medium tracking-tight text-foreground/80">
        ...
        are saying about{" "}
        <span className="from-fg-onAccent text-purple-600">UI Forge</span>
      </h3>
